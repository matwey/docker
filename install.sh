...
zypper -n --gpg-auto-import-keys install --no-recommends --auto-agree-with-licenses --force-resolution btrfsprogs gcc iproute2 iputils hostname kmod kmod-compat libelf-devel make openssh wicked

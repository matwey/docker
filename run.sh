...
make -C /usr/src/u-boot rock64-rk3328_defconfig
...
${KBUILD_OUTPUT}/tools/mkimage -n rk3328 -T rksd -d /usr/src/rkbin/bin/rk33/rk3328_ddr_333MHz_v1.16.bin /boot/idbloader.img
